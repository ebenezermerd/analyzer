...
class CacheStore:
    ...
    def __init__(
        ...
        enabled: bool = True,
        ttl_search: int = TTL_SEARCH,
        ttl_issues: int = TTL_ISSUES,
        ttl_repo: int = TTL_REPO,
        ttl_trending: int = TTL_TRENDING,
    ):
        self.base_dir = base_dir or CACHE_DIR
        self.enabled = enabled
        self.ttl_search = ttl_search
        self.ttl_issues = ttl_issues
        self.ttl_repo = ttl_repo
        self.ttl_trending = ttl_trending
        self._hits = 0
        self._misses = 0
        if enabled:
