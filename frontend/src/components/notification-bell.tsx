    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute right-0 top-full mt-2 w-80 glass-strong rounded-lg border border-border/30 shadow-xl z-50">
                    ...
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {n.issue_title && (
                            <p className="text-muted-foreground truncate mt-0.5">{n.issue_title}</p>
                          )}
